@echo off
echo Building Task Manager JAR File...
echo.
...
cd target\classes
jar cf ..\TaskManager.jar com/example/taskmanager/**/*.class
cd ..\..
REM Add manifest to existing JAR
jar ufm target\TaskManager.jar manifest.txt
...
echo 2. Run: java -jar TaskManager.jar
echo.
echo To create an EXE file later:
echo 1. Download Launch4j from: https://launch4j.sourceforge.net/
echo 2. Install it
echo 3. Run: build_exe.bat
echo.
pause
